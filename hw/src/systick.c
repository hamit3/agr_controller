...
if(fOpenRelay_5_WithDelay)	
{
	--relayOpenDelayMs;
	if(relayOpenDelayMs == 0)
	{
		fOpenRelay_5_WithDelay = 0;
		fOpenRelay5 = 1;
	}
}	

if(fOpenRelay_6_WithDelay)	
{
	--relayOpenDelayMs;
	if(relayOpenDelayMs == 0)
	{
		fOpenRelay_6_WithDelay = 0;
		fOpenRelay6 = 1;
	}
}	

if(fOpenRelay_7_WithDelay)	
{
	--relayOpenDelayMs;
	if(relayOpenDelayMs == 0)
	{
		fOpenRelay_7_WithDelay = 0;
		fOpenRelay7 = 1;
	}
}	
...
//-----------------//	
	if(powerON)
	{
		if(cntPowerOn4second)
		{
			...
			else if(cntPowerOn4second>=4000)
			{
			...
			else if(cntPowerOn4second>=3200)
			{
			...
			else if(cntPowerOn4second>=2400)
			{

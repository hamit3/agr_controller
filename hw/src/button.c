				...
				if (lvdcnt == 15)			// 15*160 = ~2.4 sec 
				{
					...
					{	  
						if(fAnyRelayON)
						{
							...
							if((fRelay5Status)&(!fStartManuelWork)&(!fStartAllRelayManuelWork))
							{
								fCloseRelay5 = 1;
							}
							if((fRelay6Status)&(!fStartManuelWork)&(!fStartAllRelayManuelWork))
							{
								fCloseRelay6 = 1;
							}
							if((fRelay7Status)&(!fStartManuelWork)&(!fStartAllRelayManuelWork))
							{
								fCloseRelay7 = 1;
							}							
						}

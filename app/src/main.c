...
void batteryVoltageCon(void)
{
		...
		if (batteryVoltage < 6.8)  // batvoltaj<6.8 röleleri kapat, pil bitiyor
		{
			...
			if(fRelay5Status)
			{
				fCloseRelay5 = 1; //  açik bir röle varsa kapat
			}
			if(fRelay6Status)
			{
				fCloseRelay6 = 1;
...
void copyAndPasteSelSettings(void)
{
	...
	{	
		...
		sel_work_duration[6] = sel_work_duration[0];
		sel_work_duration[5] = sel_work_duration[0];	
		sel_work_duration[4] = sel_work_duration[0];		
		sel_work_duration[3] = sel_work_duration[0];
		sel_work_duration[2] = sel_work_duration[0];	
		sel_work_duration[1] = sel_work_duration[0];

		sel_delayed_irr_val[6] = sel_delayed_irr_val[0];
		sel_delayed_irr_val[5] = sel_delayed_irr_val[0];	
		sel_delayed_irr_val[4] = sel_delayed_irr_val[0];		
		...
		sel_manuel_work_duration[6] = sel_manuel_work_duration[0];
		sel_manuel_work_duration[5] = sel_manuel_work_duration[0];	
		sel_manuel_work_duration[4] = sel_manuel_work_duration[0];			
		...
		sel_special_irr_days[6] = sel_special_irr_days[0];
		sel_special_irr_days[5] = sel_special_irr_days[0];	
		sel_special_irr_days[4] = sel_special_irr_days[0];	
		...
		sel_start_time_min[4][0] = sel_start_time_min[0][0];
		sel_start_time_min[4][1] = sel_start_time_min[0][1];
		sel_start_time_min[4][2] = sel_start_time_min[0][2];
		sel_start_time_min[4][3] = sel_start_time_min[0][3];	
		sel_start_time_min[5][0] = sel_start_time_min[0][0];
		sel_start_time_min[5][1] = sel_start_time_min[0][1];
		sel_start_time_min[5][2] = sel_start_time_min[0][2];
		sel_start_time_min[5][3] = sel_start_time_min[0][3];	
		sel_start_time_min[6][0] = sel_start_time_min[0][0];
		sel_start_time_min[6][1] = sel_start_time_min[0][1];
		sel_start_time_min[6][2] = sel_start_time_min[0][2];
		sel_start_time_min[6][3] = sel_start_time_min[0][3];	
		...
		sel_start_time_hour[4][0] = sel_start_time_hour[0][0];
		sel_start_time_hour[4][1] = sel_start_time_hour[0][1];
		sel_start_time_hour[4][2] = sel_start_time_hour[0][2];
		sel_start_time_hour[4][3] = sel_start_time_hour[0][3];		
		sel_start_time_hour[5][0] = sel_start_time_hour[0][0];
		sel_start_time_hour[5][1] = sel_start_time_hour[0][1];
		sel_start_time_hour[5][2] = sel_start_time_hour[0][2];
		sel_start_time_hour[5][3] = sel_start_time_hour[0][3];		
		sel_start_time_hour[6][0] = sel_start_time_hour[0][0];
		sel_start_time_hour[6][1] = sel_start_time_hour[0][1];
		sel_start_time_hour[6][2] = sel_start_time_hour[0][2];
		sel_start_time_hour[6][3] = sel_start_time_hour[0][3];		
...
//		LockNVM();
		...
		sel_work_duration[4] = 0;
		sel_work_duration[5] = 0;
		sel_work_duration[6] = 0;		
		sel_delayed_irr_val[0] = 0;
		sel_delayed_irr_val[1] = 0;
		sel_delayed_irr_val[2] = 0;
		sel_delayed_irr_val[3] = 0;
		sel_delayed_irr_val[4] = 0;
		sel_delayed_irr_val[5] = 0;
		sel_delayed_irr_val[6] = 0;
		sel_manuel_work_duration[0] = 0;
		sel_manuel_work_duration[1] = 0;
		sel_manuel_work_duration[2] = 0;
		sel_manuel_work_duration[3] = 0;
		sel_manuel_work_duration[4] = 0;
		sel_manuel_work_duration[5] = 0;
		sel_manuel_work_duration[6] = 0;		
		...
		sel_special_irr_days[4] = 0;
		sel_special_irr_days[5] = 0;
		sel_special_irr_days[6] = 0;		
		...
		sel_start_time_min[4][0] = 0;
		sel_start_time_min[4][1] = 0xFF;
		sel_start_time_min[4][2] = 0xFF;	
		sel_start_time_min[4][3] = 0xFF;	
		sel_start_time_min[5][0] = 0;
		sel_start_time_min[5][1] = 0xFF;
		sel_start_time_min[5][2] = 0xFF;	
		sel_start_time_min[5][3] = 0xFF;	
		sel_start_time_min[6][0] = 0;
		sel_start_time_min[6][1] = 0xFF;
		sel_start_time_min[6][2] = 0xFF;	
		sel_start_time_min[6][3] = 0xFF;			
		...
		sel_start_time_hour[4][0] = 0;
		sel_start_time_hour[4][1] = 0xFF;
		sel_start_time_hour[4][2] = 0xFF;	
		sel_start_time_hour[4][3] = 0xFF;
		sel_start_time_hour[5][0] = 0;
		sel_start_time_hour[5][1] = 0xFF;
		sel_start_time_hour[5][2] = 0xFF;	
		sel_start_time_hour[5][3] = 0xFF;		
		sel_start_time_hour[6][0] = 0;
		sel_start_time_hour[6][1] = 0xFF;
		sel_start_time_hour[6][2] = 0xFF;	
		sel_start_time_hour[6][3] = 0xFF;		
		//	
		for(int i= 0; i<56; i++)
		{
			relayCelendar[i] =0;
...
void manuelAllWorkCelender(void)
{
	...
	for(int i= 0; i<56; i++)   // manuel kuruldugunda önce çalisan programi iptal et ve temizle
	{
		relayCelendar[i] =0;
		pendingRtcIrq[i] =0;
	}
	...
	if( SELENOID_NUMBER  >= 1)    // NUMBERS OF SELENOID  >= 1
	{
		...
		pendingRtcIrq[42] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // 3 saniye sonrasina kurun
		pendingRelay[42] = 1;
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);
		pendingRtcIrq[43] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // kapat
		pendingRelay[43] = 1;
	}
	...
	if( SELENOID_NUMBER  >= 2)    // NUMBERS OF SELENOID  >= 2
	{
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);
		pendingRtcIrq[44] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // 3 saniye sonrasina kurun	
		pendingRelay[44] = 2;
		tmpSec = tmpSecTens *10 + tmpSecUnits;
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);
		pendingRtcIrq[45] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // kapat
		pendingRelay[45] = 2;
	}
	...
	if( SELENOID_NUMBER  >= 3)    // NUMBERS OF SELENOID  >= 3
	{
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);	
		pendingRtcIrq[46] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // 3 saniye sonrasina kurun	
		pendingRelay[46] = 3;
		tmpSec = tmpSecTens *10 + tmpSecUnits;
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);
		pendingRtcIrq[47] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // kapat
		pendingRelay[47] = 3;
	}	
	...
	if( SELENOID_NUMBER  >= 4)    // NUMBERS OF SELENOID  >= 4
	{
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);	
		pendingRtcIrq[48] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // 3 saniye sonrasina kurun	
		pendingRelay[48] = 4;
		tmpSec = tmpSecTens *10 + tmpSecUnits;
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);
		pendingRtcIrq[49] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // kapat
		pendingRelay[49] = 4;
	}	

	if( SELENOID_NUMBER  >= 5)    // NUMBERS OF SELENOID  >= 5
	{
		//röle 5
		tmpSec = tmpSecTens *10 + tmpSecUnits + 2; 		// 2 sec delay
		tmpMin = tmpMinTens * 10 + tmpMinUnits + 3*workingDelay + (tmpSec/60);
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);	
		pendingRtcIrq[50] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // 3 saniye sonrasina kurun	
		pendingRelay[50] = 4;
		tmpSec = tmpSecTens *10 + tmpSecUnits;
		tmpMin = tmpMinTens * 10 + tmpMinUnits + 4*workingDelay + (tmpSec/60);
		tmpHour = tmpHourTens * 10 + tmpHourUnits + (tmpMin/60) ;
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);
		pendingRtcIrq[51] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // kapat
		pendingRelay[51] = 4;
	}		
	
	if( SELENOID_NUMBER  >= 6)    // NUMBERS OF SELENOID  >= 6
	{
		//röle 6
		tmpSec = tmpSecTens *10 + tmpSecUnits + 2; 		// 2 sec delay
		tmpMin = tmpMinTens * 10 + tmpMinUnits + 3*workingDelay + (tmpSec/60);
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);	
		pendingRtcIrq[52] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // 3 saniye sonrasina kurun	
		pendingRelay[52] = 4;
		tmpSec = tmpSecTens *10 + tmpSecUnits;
		tmpMin = tmpMinTens * 10 + tmpMinUnits + 4*workingDelay + (tmpSec/60);
		tmpHour = tmpHourTens * 10 + tmpHourUnits + (tmpMin/60) ;
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);
		pendingRtcIrq[53] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // kapat
		pendingRelay[53] = 4;
	}	

	if( SELENOID_NUMBER  >= 7)    // NUMBERS OF SELENOID  >= 7
	{
		//röle 7
		tmpSec = tmpSecTens *10 + tmpSecUnits + 2; 		// 2 sec delay
		tmpMin = tmpMinTens * 10 + tmpMinUnits + 3*workingDelay + (tmpSec/60);
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);	
		pendingRtcIrq[54] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // 3 saniye sonrasina kurun	
		pendingRelay[54] = 4;
		tmpSec = tmpSecTens *10 + tmpSecUnits;
		tmpMin = tmpMinTens * 10 + tmpMinUnits + 4*workingDelay + (tmpSec/60);
		tmpHour = tmpHourTens * 10 + tmpHourUnits + (tmpMin/60) ;
		...
		tmpHour=tmpHour%24;
		tmpHour=bcd2cnv(tmpHour);
		pendingRtcIrq[55] = (0x80000000 |(tmpHour<<16) | (tmpMin<<8)  | (tmpSec)); // kapat
		pendingRelay[55] = 4;
	}		
...
void manuelWorkCelender(void)
{
	...
	else if(selectedSelenoid == 5)
	{
		fOpenRelay_5_WithDelay = 1;
		relayOpenDelayMs = 2000;
	}
	else if(selectedSelenoid == 6)
	{
		fOpenRelay_6_WithDelay = 1;
		relayOpenDelayMs = 2000;
	}
	else if(selectedSelenoid == 7)
	{
		fOpenRelay_7_WithDelay = 1;
		relayOpenDelayMs = 2000;
	}	
}
...
void programCelendar(void)
{
	...
	updateRelayCelendar(5); // update Relay 2 celender
	updateRelayCelendar(6); // update Relay 3 celender
	updateRelayCelendar(7); // update Relay 4 celender	
}
...
uint8_t updateRTCAlarm(void)
{
	...
	else
	{
		if(currentTime > (pendingRtcIrq[prgNum]&0x7FFFFFFF))
		{
			...
			if(prgNum < 55) //55 den büyük olamaz zaten normalde (55 iken son 7. rölede bazen problem oldugu söylendi, tekrar bak bu kisma ??? )
			{
...
void updateSelenoidPosition(uint8_t prgNum)
{
	...
	else
	{
		if(prgNum%2)  // program number tek sayi
		{
			...
			else if(pendingRelay[prgNum-1] == 5)
			{
				fOpenRelay5 = 1;
			}	
			else if(pendingRelay[prgNum-1] == 6)
			{
				fOpenRelay6 = 1;
			}
			else if(pendingRelay[prgNum-1] == 7)
			{
				fOpenRelay7 = 1;
			}			

...
extern uint8_t fPowerOnRelay5OFF;
extern uint8_t fPowerOnRelay6OFF;
extern uint8_t fPowerOnRelay7OFF;
...
extern uint8_t fRelay5Status;
extern uint8_t fRelay6Status;
extern uint8_t fRelay7Status;
...
extern uint8_t fOpenRelay_5_WithDelay;
extern uint8_t fOpenRelay_6_WithDelay;
extern uint8_t fOpenRelay_7_WithDelay;
...
extern uint32_t relayCelendar[56];

extern uint32_t pendingRtcIrq[56];
		
extern uint32_t pendingRelay[56];

//USER ADJUSTED VALUES
extern uint8_t sel_work_duration[7];
extern uint8_t sel_delayed_irr_val[7];
extern uint8_t sel_start_time_min[7][4];
extern uint8_t sel_start_time_hour[7][4];
extern uint8_t sel_special_irr_days[7];
extern uint8_t sel_manuel_work_duration[7];
